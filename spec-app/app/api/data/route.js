...
const DEFAULT_DATA = {
  ...
  tasks: [
    ...
    {id:9,text:'Wybór i rezerwacja zespołu muzycznego (odsłuchaj propozycje w zakładce Artyści)',cat:'art',done:false},
  ...
  program: [
    {id:1,time:'27 listopada',name:'🛠️ Przygotowania i dekoracje',desc:'Do ogarnięcia dzień wcześniej: czerwony dywan, wstęga do przecięcia, hokery i stoliki, słodki stolik, stanowiska barmana i baristy',badge:'',featured:false},
    ...
    {id:3,time:'12:15 – 16:00',name:'🏢 Zwiedzanie obiektu',desc:'Gości prowadzi się przez nowy oddział; na ścianach wystawa zdjęć dokumentująca historię powstawania firmy',badge:'',featured:false},
    {id:4,time:'16:00 – 17:00',name:'🚗 Przejazd do Hotelu Via Baltica',desc:'Grzymały Szczepankowskie 1A — możliwość zorganizowania transportu dla gości',badge:'',featured:false},
    {id:5,time:'19:00',name:'🥂 Bal otwarcia — Hotel Via Baltica',desc:'Uroczysta kolacja, catering, oprawa muzyczna — zespół na żywo (do wyboru)',badge:'Bal',featured:true},
    {id:6,time:'21:00 – 22:00',name:'🎤 Marcin Daniec — kabaret',desc:'Potwierdzony występ — 28 listopada, godz. 21:00, z wielką chęcią w Łomży / Stawiskach',badge:'Gwiazda wieczoru · 15 500 zł netto',featured:true},
    {id:7,time:'22:00 – 23:30',name:'💃 Część taneczna i networking',desc:'Muzyka, drinki, pamiątkowe zdjęcia, nieformalne rozmowy z partnerami i gośćmi',badge:'',featured:false},
  ],
  artists: {
...
export async function GET() {
  try {
    ...
    if (error || !data) {
      ...
      await supabase.from('event_data').upsert({ key: 'main', value: DEFAULT_DATA })
